  ...
  const packages = [
    {
      ...
      whoFor: "E-commerce sites, high-traffic applications, or any business losing conversions to slow performance.",
      deliverables: [
    ...
    },
    {
      ...
      whoFor: "E-commerce sites experiencing checkout abandonment, payment failures, or inconsistent funnel behavior.",
      deliverables: [
    ...
    },
    {
      ...
      whoFor: "Teams struggling with tech debt, slow feature delivery, or frequent production regressions.",
      deliverables: [
